"""DKB Festgeld (fixed-term deposit) statement parser."""
...
from fintl.etl.providers.dkb.giro202307 import extract_balance
from fintl.etl.providers.dkb.giro202312 import detect_separator

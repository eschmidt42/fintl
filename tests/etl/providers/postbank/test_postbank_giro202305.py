"""Tests for postbank.giro202305 parser."""
...
from fintl.etl.providers.postbank import giro202305 as giro


@pytest.fixture
def csv_file(files_root_path: Path) -> Path:
    """Return the path to the Postbank giro202305 CSV fixture file."""
    return (
        files_root_path
        / "csv_files"
        / "Postbank"
...
def test_main(tmp_path: Path, csv_file: Path, logger_config_path: Path):
    """Postbank giro202305 parser runs end-to-end and produces expected output files."""
